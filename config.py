...
class DevelopmentConfig(Config):
    ...
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = os.environ.get("DEV_DATABASE_URL") or "sqlite:///%s" % (
...
class TestingConfig(Config):
    ...
    DEBUG = False
    TESTING = True
    SQLALCHEMY_DATABASE_URI = os.environ.get("TEST_DATABASE_URL") or "sqlite:///%s" % (
        os.path.join(basedir, "database-test.db")
    )
