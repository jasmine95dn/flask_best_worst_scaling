...
def profile(some_name):
    ...
    projects = (
        {
            i + 1: {
                ...
                "name": project.name,
                "description": project.description[:21] + "...",
                "n_anno": project.anno_number,
                "best": project.best_def,
                "worst": project.worst_def,
            }
    ...
    title_styles = {
        ...
        "Definition of 'best'": "30",
        "Definition of 'worst'": "30",
        "Description": "100",
    }
    if projects:
        projects = projects.items()
    return render_template(
        "user/profile.html", name=some_name, projects=projects, styles=title_styles.items(), keys=other_keys
    )
...
def project(some_name, p_name):
    ...
    return render_template(
        ...
        n_anno_join=n_anno_join,
        n_anno_left=n_anno_left,
