...
def test_valid_signup(test_client, init_database):
    ...
    response = test_client.post(
        "/user/signup", data=dict(username="jung2", email="abcd@abc.de", password="12345679"), follow_redirects=True
    )
    # 1.
    assert response.status_code == 200
    # 2.
...
def test_invalid_username_signup(test_client, init_database):
    ...
    """
    response = test_client.post(
        "/user/signup", data=dict(username="jung", email="abcde@abc.de", password="abcdefghij"), follow_redirects=True
    )
    # 1.
    assert response.status_code == 200
    # 2.
	...
	"""
    response = test_client.post(
        "/user/signup", data=dict(username="jun", email="abcdef@abc.de", password="abcdefghij"), follow_redirects=True
    )
    # 1.
    assert response.status_code == 200
    # 2.
...
def test_invalid_email_signup(test_client, init_database):
    ...
    """
    response = test_client.post(
        "/user/signup", data=dict(username="maryna", email="abc@abc.de", password="abcdefghij"), follow_redirects=True
    )
    # 1.
    assert response.status_code == 200
    # 2.
	...
	"""
    response = test_client.post(
        "/user/signup", data=dict(username="jung234", email="abc@dede", password="abcdefghij"), follow_redirects=True
    )
    # 1.
    assert response.status_code == 200
    # 2.
...
def test_invalid_password_signup(test_client, init_database):
    ...
    """
    response = test_client.post(
        "/user/signup", data=dict(username="jung234", email="abcdef@abc.de", password="abc"), follow_redirects=True
    )
    # 1.
    assert response.status_code == 200
    # 2.
...
def test_valid_login_logout(test_client, init_database):
    ...
    """
    response = test_client.post(
        "/user/login", data=dict(username="jung", password="12345678", remember=False), follow_redirects=True
    )
    # 1.
    assert response.status_code == 200
    # 2.
...
def test_invalid_username_login(test_client, init_database):
    ...
    """
    response = test_client.post(
        "/user/login", data=dict(username="jung3", password="12345678", remember=True), follow_redirects=True
    )
    # 1.
    assert response.status_code == 200
    # 2.
...
def test_invalid_password_login(test_client, init_database):
    ...
    """
    response = test_client.post(
        "/user/login", data=dict(username="jung", password="12345679", remember=True), follow_redirects=True
    )
    # 1.
    assert response.status_code == 200
    # 2.
